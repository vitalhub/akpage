			...
			<div class="homeNews">
				<div id="registration-tabs">
					<ul id="myTab" class="nav nav-pills nav-justified" role="tablist">
					  <li role="presentation" class="active"><a aria-controls="step1" role="tab"><span class="glyphicon glyphicon-forward"></span> Step 1</a></li>
					  <li role="presentation"><a aria-controls="step2" role="tab"><span class="glyphicon glyphicon-forward"></span> Step 2</a></li>
					...
					<div id="myTabContent" class="tab-content">
						...
						<div role="tabpanel" class="tab-pane fade active in" id="step1">
