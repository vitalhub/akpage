			...
			<tr>
				...
				<td class="actions">
					...
					<?php 
						...
						echo $this->Form->postLink($this->Html->image("actionIcons/reactivate-icon.png",array('title'=>__('Re-activate'),'width'=>'26','height'=>'26')), array('action' => 'reActivate', $user['User']['id']), array('escape'=>false), __('Are you sure you want to Re-activate # %s?', $user['User']['id']))."&nbsp; &nbsp; &nbsp;";
					?>
				</td>
			</tr>
		<?php endforeach; ?>
