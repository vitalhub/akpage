...
<div class="homeNews" style="border: 0;">
	...
	<h5 class="head4 bold" id="family">
		<?php echo __('Expected Partner Details'); ?>
	</h5>
	...
	<div class="matrimonyUsers form" style="padding: 10px;">
		...
		<table class="table table-bordered table-striped table-hover">
			...
			<tr>
				...
				<td class="capitalize"><?php echo $this->Form->input('partnerQualification',array('type'=>'text','label'=> false, 'required' => true, 'class' => 'form-control capitalize', 'required' => false)); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="capitalize"><?php $options=array('Below 4ft 5in'=>'Below 4ft 5in', '4ft 5in'=>'4ft 5in', '4ft 6in'=>'4ft 6in', '4ft 7in'=>'4ft 7in', '4ft 8in'=>'4ft 8in', '4ft 9in'=>'4ft 9in', '4ft 10in'=>'4ft 10in', '4ft 11in'=>'4ft 11in', '5ft'=>'5ft', '5ft 1in'=>'5ft 1in'
			...
			<tr>
				...
				<td><?php $options=array('18'=>'18', '19'=>'19', '20'=>'20', '21'=>'21', '22'=>'22', '23'=>'23', '24'=>'24', '25'=>'25', '26'=>'26', '27'=>'27', '28'=>'28', '29'=>'29', '30'=>'30', '31'=>'31', '32'=>'32', '33'=>'33', '34'=>'34', '35'=>'35', '36'=>'36', '37'=>'37', '38'=>'38', '39'=>'39', '40'=>'40');
						...
						echo $this->Form->input('fromAge',array('options' => $options, 'empty' => __('Select Minimum'), 'div' => false, 'label'=> false, 'class' => 'form-control capitalize col-md-4 col-lg-4', 'style' => array('width : auto !important ; margin : 0px 5px'), 'required' => false)); ?>
					...
					$options=array('19'=>'19', '20'=>'20', '21'=>'21', '22'=>'22', '23'=>'23', '24'=>'24', '25'=>'25', '26'=>'26', '27'=>'27', '28'=>'28', '29'=>'29', '30'=>'30', '31'=>'31', '32'=>'32', '33'=>'33', '34'=>'34', '35'=>'35', '36'=>'36', '37'=>'37', '38'=>'38', '39'=>'39', '40'=>'40', '41'=>'41', '42'=>'42', '43'=>'43', '44'=>'44', '45'=>'45', '46'=>'46'
										, '47'=>'47', '48'=>'48', '49'=>'49', '50'=>'50');
									 	  ...
									 	  echo $this->Form->input('toAge',array('options' => $options, 'empty' => __('Select Maximum'), 'div' => false, 'label'=> false, 'class' => 'form-control capitalize col-md-4 col-lg-4', 'style' => array('width : auto !important ; margin : 0px 5px'), 'required' => false)); ?>
			...
			<tr>
				...
				<td class="capitalize"><?php echo $this->Form->input('partnerCity_id',array('id'=>'city2', 'type' => 'select', 'empty' => 'Select City', 'label'=> false, 'required' => false, 'class' => 'form-control capitalize')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="capitalize"><?php echo $this->Form->input('partnerSmoking',array('type'=>'radio','options'=>array('No','Yes'), 'div' => false, 'label' => false, 'legend' => false, 'class' => 'capitalize custom-radio', 'required' => false)); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="capitalize"><?php echo $this->Form->input('partnerDrinking',array('type'=>'radio','options'=>array('No','Yes'), 'div' => false, 'label' => false, 'legend' => false, 'class' => 'capitalize custom-radio', 'required' => false)); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="capitalize"><?php echo $this->Form->input('aboutPartner',array('type' => 'textarea', 'label'=> false, 'class' => 'form-control capitalize', 'required' => false)); ?>
				</td>
			</tr>
		...
		<div class="align-right">
			...
			<?php echo $this->Form->submit(__('Submit'), array('name' => 'next', 'class' => array('btn', 'btn-success', 'btn-md'), 'div' => false)); ?>
		</div>
