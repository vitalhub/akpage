			...
			<div class="homeNews">
				<div id="registration-tabs">
					<ul id="myTab" class="nav nav-pills nav-justified" role="tablist">
					  ...
					  <li role="presentation" class="active"><a aria-controls="step4" role="tab"><span class="glyphicon glyphicon-forward"></span> Step 4</a></li>
					</ul>
					...
					<div id="myTabContent" class="tab-content">
						...
						<div role="tabpanel" class="tab-pane fade active in" id="step4">
