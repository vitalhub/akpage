<?php if(!$currentUser){
	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-7">
		...
		<h4><?php echo __('Admins'); ?></h4>		
			...
			<?php  if($currentUser['group_id'] == 1){
						
					echo $this->Html->link($this->Form->button('Add Admin', array('class' => 'btn btn-md btn-success')), array('action' => 'register'), array('escape'=>false,'title' => "Click to add admin."));
				}
